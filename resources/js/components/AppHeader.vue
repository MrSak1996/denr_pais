...
import { BookOpen, Folder, LayoutGrid, Users, Menu, Search, ListCheck, List } from 'lucide-vue-next';
...
const mainNavItems = computed<NavItem[]>(() => {
    ...
    switch (roleId) {
        case 1:
            dashboardHref = '/applications/pending_application'; // Admin Dashboard
            break;
        case 2:
            dashboardHref = '/rps-chief-dashboard'; // RPS Staff
            break;
        case 3:
            dashboardHref = '/cenro-dashboard'; // Another role
            break;
        case 4:
            dashboardHref = '/penro-technical-dashboard';
        case 5:
            dashboardHref = '/penro-rps-chief-dashboard';
        case 6:
            dashboardHref = '/penro-tsd-chief-dashboard';
        case 7:
            dashboardHref = '/penro-dashboard';
        case 8:
            dashboardHref = '/rts-dashboard';
        case 9:
            dashboardHref = '/fus-dashboard';
        case 10:
            dashboardHref = '/lpdd-chief-dashboard';
        case 11:
            dashboardHref = '/ardts-dashboard';
        case 12:
            dashboardHref = '/regional-executive-dashboard';


        // case 4:
        //     dashboardHref = '/rps-chief-dashboard'; // RPS Chief
        //     break;
